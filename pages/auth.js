...
// const uiConfig = {
//   signInSuccessUrl: "/",
//   signInOptions: [authentication.GoogleAuthProvider.PROVIDER_ID],
// };
const auth = getAuth();
...
function SignInScreen(props) {
  ...
  return (
    <div
      ...
      <button style={{ display: !gState ? "initial" : "none" }} onClick={signIn}>
        Sign In
      </button>
      <button style={{ display: gState ? "initial" : "none" }} onClick={logOut}>
        Sign Out
      </button>
    </div>
  );
