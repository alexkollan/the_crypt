        ...
        <Segment inverted textAlign="center" style={{ height: 700 }} vertical>
          <Container inverted text>
            ...
            <Header
              ...
              Create secure encrypted message or notes. <br />
              <br />
        ...
        <Grid container stackable verticalAlign="middle">
          <Grid.Row>
            <Grid.Column width={8}>
              ...
              <p style={{ fontSize: "1.33em" }}>We can give your company superpowers to do things that they never thought possible. Let us delight your customers and empower your needs... through pure data analytics.</p>
              <Header as="h3" style={{ fontSize: "2em" }}>
                We Make Bananas That Can Dance
              </Header>
              <p style={{ fontSize: "1.33em" }}>Yes that's right, you thought it was the stuff of dreams, but even bananas can be bioengineered.</p>
            </Grid.Column>
